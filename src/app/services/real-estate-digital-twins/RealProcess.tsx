...
const steps: ProcessStep[] = [
  {
    id: 1,
    number: '01',
    title: '3D Scanning and Data Collection',
    description:
      'We use advanced 3D scanning techniques and architectural plans to capture accurate spatial data.',
  },
  {
    id: 2,
    number: '02',
    ...
    description:
      'Our artists meticulously model the structure and apply high-resolution textures to achieve photorealistic detail.',
  },
  {
    id: 3,
    number: '03',
    ...
    description:
      'We apply realistic lighting and rendering techniques to bring the digital twin to life with depth, realism, and visual impact.',
  },
  {
    id: 4,
    number: '04',
    ...
    description:
      'Our developers build interactive features and optimize the experience for smooth, responsive, and lag-free performance.',
  },
];
        ...
        <div className="space-y-4 z-[999] bring-to-front contrast-125">
          <h1 className="text-4xl sm:text-4xl md:text-6xl font-extrabold leading-tight">
            <div className="bg-gradient-to-r from-[#B54CBE]  to-[#065FE5] bg-clip-text text-transparent">
              Our Process for Creating Digital Twins
          ...
          <p className="text-gray-100 text-sm md:text-[18px] max-w-lg">
           We combine advanced technology with artistic precision to build a seamless and impressive experience
          </p>
