...
const steps: ProcessStep[] = [
 {
  ...
  description:
    'We begin by understanding your event goals, whether it’s brand awareness, lead generation, product launches, or audience engagement.',
},
{
  id: 2,
  number: '02',
  title: 'Audience & Experience Mapping',
  description:
    'We analyze your target audience and design an immersive event journey that guides visitors from entry to interaction and conversion.',
},
{
  id: 3,
  number: '03',
  title: 'Engagement & Interaction Design',
  description:
    'We plan interactive elements such as digital installations, live demos, AR/VR experiences, and branded touchpoints to captivate attendees.',
},
{
  id: 4,
  number: '04',
  ...
  description:
    'Our team handles end-to-end execution, ensuring flawless setup, real-time coordination, and a seamless experience throughout the event.',
},
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="space-y-4 z-[999] bring-to-front contrast-125">
          <h1 className="text-4xl sm:text-4xl md:text-6xl font-extrabold leading-tight">
           ...
           Our Process for Gamified Solutions
...
Our approach is rooted in understanding your objectives and the psychology of your users
   </p>
        ...
        <div className="relative max-w-[560px] mx-auto w-full">
          {/* Fixed viewport container with consistent padding and overflow hidden */}
          <div className="relative h-[560px] overflow-hidden">
            {/* Scrolling container with top padding to center first visible card */}
            <div
              className="relative w-full px-5 -mt-[46px]"
              style={{
                  ...
                  return (
                    ...
                    >
                      ...
                      {isVisible && positionIndex === 1 && (
                        <div 
                          className="absolute -right-10 md:-right-5 p-2 z-20 pointer-events-none"
                          style={{ 
                            bottom: '-32px',
                            opacity: isCenter ? 1 : 0.5,
                            transition: 'all 0.8s cubic-bezier(0.45, 0, 0.15, 1)'
                      ...
                      <div
                        className={`
                          ...
                          ${
                            isCenter
                              ? 'bg-gradient-to-b from-[#B44BBD] via-[#854CBE] to-[#205CE0] !ml-6'
