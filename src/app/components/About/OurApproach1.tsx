      ...
      <div className="max-w-9xl mx-auto bg-[#EDEAFF] rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="text-center -11 px-4 sm:px-8 pb-16 lg:px-16">
          ...
          <p className="text-[#787298] pt-11 max-w-3xl mx-auto text-base sm:text-lg leading-relaxed">
            To be the leading immersive technology partner in the Middle East,
            recognized for our creative excellence, technical expertise, and our
            unwavering commitment to our clients' success. We are proud to be
            contributing to Saudi Vision 2030 by empowering businesses to
            embrace digital transformation and shape a new, more interactive
