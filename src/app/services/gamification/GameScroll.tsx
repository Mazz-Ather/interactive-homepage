...
const services: ServiceCard[] = [
  {
    ...
    description:
      'Use points, badges, and leaderboards to make training modules more interactive and effective, increasing knowledge retention and skill development.',
  },
  {
    id: 2,
    ...
    description:
      'Implement reward systems, challenges, and user progression to build a stronger connection with your customers and encourage repeat business.',
  },
  {
    id: 3,
    ...
    description:
      'Launch interactive campaigns and mini-games that entertain your audience while subtly promoting your brand and message.',
  },
];


const GameScroll: React.FC = () => {
  ...
  return (
    ...
    How We Help with Gamification

        </h2>
        <p className="text-gray-400 text-center text-lg md:text-xl max-w-3xl mx-auto">
    
We work with you to integrate game mechanics into your existing systems or create new, gamified solutions from scratch.
