...
const ThreedProductionProcess: React.FC = () => {
 ...
 const steps: ProcessStep[] = [
  ...
  },
  {
    ...
    description: 'We bring the models to life through professional animation and rigging.',
  },
  {
    id: 4,
    number: '04',
    title: 'Lighting, Rendering & VFX',
    description: 'We add lighting, render the final scenes, and apply any necessary visual effects.',
  },
  {
    id: 5,
    number: '05',
    title: 'Compositing & Final Edit',
    description: ' We combine all the elements, add sound and music, and deliver the final polished animation',
  },
];
...
<div className="absolute top-1/2 right-0 w-96 h-96 bg-orange-600/20 rounded-full blur-3xl z-[2] pointer-events-none"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="relative   max-w-[560px] mx-auto w-full">
          <div className="relative -mt-11 h-[590px]">
            {/* Scrolling container */}
            <div
...
export default ThreedProductionProcess;