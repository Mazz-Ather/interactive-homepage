...
const servicesOur: Service[] = [
  {
    ...
    detailedDescription:
      "We work with you to brainstorm creative ideas and define a strategic approach that aligns with your event goals.",
  },
  {
    id: 2,
    ...
    detailedDescription:
      "We create detailed plans for the space, technology integration, and user journey to ensure a seamless experience.",
  },
  {
    id: 3,
    ...
    detailedDescription:
      "We develop all the necessary custom content, including 3D animations, interactive software, and AR filters.",
  },
  {
    id: 4,
    ...
    detailedDescription:
      "We handle all on-site setup and provide a dedicated technical team for the duration of the event to ensure everything runs smoothly",
  },
];
//   animation services
...
const page = () => {
  ...
  const services: ServiceCard[] = [
    {
      title: "Interactive Exhibition Booths:",
      description:
        "We design and build booths that are not just displays, but interactive destinations, using AR, VR, and interactive screens to draw in visitors.",
    },
    {
      title: "AR Brand Activations:",
      description:
        "We create engaging augmented reality experiences that allow audiences to interact with your brand in a unique, mobile-first way.",
    },
    {
      title: "3D Animation & Visualisation:",
      description:
        "We produce stunning 3D content for large-scale LED screens, event intros, and promotional materials that set the tone for your event.",
    },
  ];
  ...
  const servicesAnimation: ServiceItem[] = [
    {
      ...
      title: "The Challenge",
      description:
        "A brand wanted to create a memorable experience at a major trade show to stand out from competitors.",
    },
    {
      id: 2,
      ...
      title: "The Solution",
      description:
        "We developed an interactive AR experience where attendees could scan a logo to see a 3D animated character come to life and pose for photos, which they could share on social media.",
    },
    {
      id: 3,
      ...
      title: "The Result",
      description:
        "The activation created significant social media buzz, driving a high volume of traffic to the booth and generating strong brand awareness.",
    },
  ];
  //
  const projects = [
          ...
          <div className="container mx-auto px-6 md:px-12 lg:px-28">
            <div className="max-w-xl lg:!max-w-[45%] ">
              ...
              <p className="text-white/85 text-xs sm:text-sm md:text-base leading-relaxed mb-5 md:mb-6">
                The events and entertainment industry is driven by innovation
                and spectacle. At AO Interactive, we help brands and organizers
                create unforgettable experiences that go beyond the ordinary.
                Our immersive solutions captivate audiences, drive engagement,
                and generate valuable buzz for your brand in Saudi Arabia.
              </p>
        ...
        <div className="relative z-10 max-w-8xl mx-auto w-full">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-4">
            <span className="bg-gradient-to-r from-[#B54CBE]  to-[#065FE5] text-transparent bg-clip-text">
              How We Help Events & Entertainment
            </span>
          </h2>

          {/* Paragraph */}
          <p className="text-gray-400 text-center text-sm md:text-lg max-w-3xl mx-auto mb-20">
            We provide a range of creative and technical services to make your
            event a showstopper.
          </p>
              ...
              <div className="flex flex-col lg:flex-row items-start justify-between mb-16 gap-6">
                ...
                <div className="flex flex-col items-end gap-4 max-w-md ml-auto">
                  <p className="text-gray-900 text-sm sm:text-base md:text-lg leading-relaxed text-right">
                    Our process is designed to bring your event vision to life,
        ...
        <div className="relative z-10 w-full px-4 py-8">
          ...
          >
            ...
            <p className="mx-auto max-w-2xl text-base text-gray-300 md:text-lg lg:text-xl">
              Interactive Brand Activation at a Major Saudi Expo:
            </p>
          </motion.div>
