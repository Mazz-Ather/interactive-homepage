...
export function VideoScrollHero({
  videoSrc = "https://res.cloudinary.com/dnqcj9kh3/video/upload/v1758985531/video2_owerib.mp4",
        ...
        <div className="sticky top-0 w-full h-screen flex items-center justify-center z-10">
          ...
          >
            <video
              ...
              muted
              playsInline
              className="w-[80vw] max-w-7xl h-[82vh] object-cover shadow-2xl rounded-2xl"
            >
