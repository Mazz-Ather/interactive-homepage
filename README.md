...
const steps: ProcessStep[] = [
  {
    ...
    description: 'We discuss your goals and create a clear plan to ensure the best outcome.',
  },
  {
    id: 2,
    number: '02',
    title: 'Design & Development:',
    description: 'Our team develops and designs solutions tailored to your needs.',
  },
  {
    id: 3,
    number: '03',
    title: 'Implementation:',
    description: 'We bring the plan to life, ensuring accuracy and quality.',
  },
  {
    id: 4,
    number: '04',
    title: 'Testing & Optimization:',
    description: 'We review and refine every detail to guarantee the best performance.',
  },
  {
    id: 5,
    number: '05',
    title: 'Delivery & Support:',
    description: 'We deliver the final product and provide ongoing support as needed.',
  },
];
...
<div className="absolute top-1/2 right-0 w-96 h-96 bg-orange-600/20 rounded-full blur-3xl z-[2] pointer-events-none"></div>
  ...
  and deliver high-quality results for every client.
          </p>
