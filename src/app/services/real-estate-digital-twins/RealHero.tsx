...
const RealHero: React.FC<HeroServiceProps> = ({
  videoSrc = 'https://res.cloudinary.com/dnqcj9kh3/video/upload/v1763379895/DG_1_wvwmnd.mp4',
  miniHeading = 'Service',
  mainHeading = 'Digital Transformation',
  description = 'In the modern real estate market of Saudi Arabia, showcasing a property full potential is key. Our Digital Twin solutions go beyond traditional static renders, providing an interactive, immersive, and highly detailed virtual model of any property. This technology transforms the buying and selling process for developers, agents, and buyers.',
    ...
    <section className="relative font-[Cairo] w-full h-screen min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        >
          ...
          Your browser does not support the video tag.<div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-black via-black/90 to-transparent" /> 
        {/* Dark Overlay */}
      ...
      <div className="relative z-10 h-full flex items-center">
       ...
       Revolutionary Real Estate Marketing with Digital Twin Technology
            </div>
