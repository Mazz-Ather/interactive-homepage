...
const servicesOur: Service[] = [
  ...
  },
  {
    ...
    detailedDescription:
      "We build the interactive functionality and optimize the experience for a seamless user journey.",
  },
  {
    id: 4,
    ...
    detailedDescription:
      " We provide the final solution, ready to be integrated into your website, and offer ongoing support.",
  },
];
//   animation services
  ...
  const services: ServiceCard[] = [
    {
      ...
      description:
        "Our interactive virtual tours and photorealistic digital twins allow potential buyers to explore properties from anywhere in the world.",
    },
    {
      title: "Digital Twin Development:",
      description:
        "We create accurate, real-time 3D models of properties that can be used for marketing, facility management, and investor relations.",
    },
    {
      title: "Architectural Visualisation:",
      description:
        "We produce stunning 3D renders and animations that bring architectural plans to life, helping you visualise projects before construction begins.",
    },
  ];
  ...
  const servicesAnimation: ServiceItem[] = [
    {
      ...
      title: "The Challenge",
      description:
        "A developer needed to market a high-end villa to international clients without on-site visits.",
    },
    {
      id: 2,
      ...
      title: "The Solution",
      description:
        "We created a fully interactive digital twin that allowed clients to navigate the home, change finishes, and even place furniture virtually.",
    },
    {
      id: 3,
      ...
      title: "The Result",
      description:
        "The digital twin became the primary sales tool, helping the developer pre-sell the property with high level client satisfaction.",
    },
  ];
  //
  const projects = [
          ...
          <div className="container mx-auto px-6 md:px-12 lg:px-28">
            <div className="max-w-xl lg:!max-w-[45%] ">
              ...
              <p className="text-white/85 text-xs sm:text-sm md:text-base leading-relaxed mb-5 md:mb-6">
                The real estate industry is evolving, and so are the
                expectations of buyers and investors. At AO Interactive, we
                provide powerful, technology-driven solutions that help
                developers, architects, real estate agents, and investors
                streamline operations, accelerating sales cycles and reducing
                marketing costs in Saudi Arabia.
              </p>
      ...
      <section className="relative font-[cairo] bg-black text-white pt-32 pb-36 px-6 overflow-hidden h-auto flex items-center">
        ...
        <div className="relative z-10 max-w-8xl mx-auto w-full">
          ...
          <p className="text-gray-400 text-center text-sm md:text-lg max-w-3xl mx-auto mb-20">
            We offer a suite of services designed to address the specific needs
              ...
              <div className="flex flex-col lg:flex-row items-start justify-between mb-16 gap-6">
                ...
                <div className="flex flex-col items-end gap-4 max-w-md ml-auto">
                  <p className="text-gray-900 text-sm sm:text-base md:text-lg leading-relaxed text-right">
                    We follow a tailored process to ensure your project delivers
                    maximum impact.
                  </p>
        ...
        <div className="relative z-10 w-full px-4 py-8">
          ...
          >
            ...
            <p className="mx-auto max-w-2xl text-base text-gray-300 md:text-lg lg:text-xl">
              Digital Twin for a Luxury Villa in Riyadh:
            </p>
          </motion.div>
