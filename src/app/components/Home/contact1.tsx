  ...
  return (
    <div id="contact-section" className="h-screen flex flex-col lg:px-20 text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 lg:py-6 w-full h-full flex flex-col">
        {/* Top Header Section */}
        <div className="flex flex-col items-center gap-4 lg:flex-row lg:items-center lg:justify-between lg:gap-0 mb-6 lg:mb-8 flex-shrink-0">
        ...
        <div className="relative flex-1 min-h-0">
          ...
          <div className="relative rounded-3xl p-4 lg:p-8 ml-0 lg:ml-[150px] h-full">
            {/* Outer container with gradient border */}
            <div className="absolute xl:-m-[7px] inset-0 rounded-3xl bg-gradint-to-r from-purple-500 via-blue-500 to-purple-500 p-[2px] overflow-hidden">
              <div className="w-full h-full bg-black rounded-3xl overflow-hidden">
                ...
                <div className="absolute inset-0">
                  ...
                  <div className="absolute inset-0 rounded-[40px] pointer-events-none">
                    ...
                    <div className="absolute blur-sm top-0 left-0 right-0 h-[40px] blurred-xl  bg-gradient-to-b from-[#6F61ED] to-transparent opacity-70"></div>
            ...
            {/* Content */}
            <div className="relative z-10 pl-0 lg:pl-48 h-full flex flex-col justify-between">
              <div>
                <h2 className="text-3xl lg:text-4xl font-semibold mb-6 lg:mb-8 leading-tight !text-[#FFFFFF5E]">
              ...
              {/* Testimonial */}
              <div className="bg-[#101010] rounded-2xl p-4 lg:p-2 border -mb-5 border-gray-800 max-w-full relative">
          ...
          {/* Contact Form */}
          <div className="absolute top-12 lg:top-12 -left-0 lg:-left-10 w-full lg:w-96 bg-[#151515] backdrop-blur-sm rounded-2xl border border-gray-700 p-4 lg:p-6 shadow-2xl">
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-4">
                <input
                  ...
                  className="px-4 py-2.5 bg-gray-800 border border-gray-600 rounded-lg text-white text-sm placeholder-gray-500 focus:outline-none focus:border-purple-500 transition-colors w-full"
                />
                <input
                  type="tel"
                  name="phone"
              ...
              <div>
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-2.5 bg-gray-800 border border-gray-600 rounded-lg text-white text-sm placeholder-gray-500 focus:outline-none focus:border-purple-500 transition-colors"
                />
              </div>
              <div>
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={3}
                  className="w-full px-4 py-2.5 bg-gray-800 border border-gray-600 rounded-lg text-white text-sm placeholder-gray-500 focus:outline-none focus:border-purple-500 transition-colors resize-none"
                />
              </div>
