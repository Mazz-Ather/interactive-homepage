...
const servicesOur: Service[] = [
  {
    id: 1,
    title: "Consumer Journey Analysis",
    href: "/services/consultation",
    image:
      "https://images.unsplash.com/photo-1551434678-e076c223a692?w=600&h=400&fit=crop",
    description: "Understanding your needs",
    detailedDescription:
      "We start by analyzing your target customer's journey and identifying key pain points and opportunities for engagement.",
  },
  {
    id: 2,
    ...
    detailedDescription:
      "Our team conceptualizes and designs an immersive experience that directly addresses your business goals, from increasing online conversions to boosting in-store foot traffic.",
  },
  {
    id: 3,
    ...
    detailedDescription:
      " We build all the necessary assets, including 3D product models, custom software, and back-end integration with your existing e-commerce platform.",
  },
  {
    id: 4,
    ...
    detailedDescription:
      "We deploy the solution and provide analytics to track user engagement, allowing us to measure the impact and continuously optimize the experience.",
  },
];
//   animation services
...
const page = () => {
  ...
  const services: ServiceCard[] = [
    {
      title: "Virtual Showrooms & Stores:",
      description:
        "We create fully immersive virtual environments where customers can browse products, interact with 3D models, and make purchases from anywhere in the world. This extends your brand's reach and provides a new, unique way to shop.",
    },
    {
      title: "AR-Powered Shopping Experiences:",
      description: `We develop augmented reality applications that allow customers to visualize products in their own space. This includes "virtual try-on" for fashion and beauty or "see it in your room" for furniture and home goods, which increases buyer confidence and reduces returns.`,
    },
    {
      title: "Immersive Marketing & Brand Activations:",
      description:
        "We design interactive marketing campaigns that use AR and gamification to create memorable brand moments, turning simple advertisements into engaging experiences.",
    },
  ];
  ...
  const servicesAnimation: ServiceItem[] = [
    {
      ...
      title: "The Challenge",
      description:
        " A fashion brand wanted to reduce online returns and provide a more interactive shopping experience.",
    },
    {
      id: 2,
      ...
      title: "The Solution",
      description:
        "We created a mobile AR application that allowed customers to virtually try on clothing and accessories using their smartphone camera.",
    },
    {
      id: 3,
      ...
      title: "The Result",
      description:
        "The solution not only increased customer engagement but also significantly reduced return rates and boosted sales confidence.",
    },
  ];
  //
  const projects = [
            ...
            <div className="max-w-xl lg:!max-w-[65%] ">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl  lg:text-6xl font-extrabold mb-3 md:mb-4 !leading-none ">
                <span className="bg-gradient-to-r from-[#B54CBE]  to-[#065FE5] bg-clip-text text-transparent !leading-[0.7]">
                  Revolutionizing the Shopping Experience with Immersive
                  Technology in KSA
                </span>
              </h1>
              ...
              <p className="text-white/85 text-xs sm:text-sm md:text-base leading-relaxed mb-5 md:mb-6">
                The retail and e-commerce landscape is undergoing a major
                transformation. Modern consumers in Saudi Arabia expect more
                than just a transaction; they demand an engaging, seamless, and
                personalized shopping journey. We help brands meet these
                expectations by blending the physical and digital worlds to
                create unforgettable retail experiences that drive sales and
                brand loyalty.
              </p>
        ...
        <div className="relative z-10 max-w-8xl mx-auto w-full">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-4">
            <span className="bg-gradient-to-r from-[#B54CBE]  to-[#065FE5] text-transparent bg-clip-text">
              How We Transform Retail & E-commerce
            </span>
          </h2>

          {/* Paragraph */}
          <p className="text-gray-400 text-center text-sm md:text-lg max-w-3xl mx-auto mb-20">
            We offer a suite of services designed to help retail brands stand
              ...
              <div className="flex flex-col lg:flex-row items-start justify-between mb-16 gap-6">
                ...
                <div className="flex flex-col items-end gap-4 max-w-md ml-auto">
                  <p className="text-gray-900 text-sm sm:text-base md:text-lg leading-relaxed text-right">
                    We combine an understanding of consumer behavior with
                    cutting-edge technology to deliver solutions that generate a
        ...
        <div className="relative z-10 w-full px-4 py-8">
          ...
          >
            ...
            <p className="mx-auto max-w-2xl text-base text-gray-300 md:text-lg lg:text-xl">
              Virtual Try-On for a Fashion Brand:
            </p>
          </motion.div>
