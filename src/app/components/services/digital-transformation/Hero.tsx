...
const DigitalHero: React.FC<HeroServiceProps> = ({
  videoSrc = 'https://res.cloudinary.com/dnqcj9kh3/video/upload/v1763379895/DG_1_wvwmnd.mp4',
  miniHeading = 'Service',
  mainHeading = 'Digital Transformation',
  description = 'We create end-to-end custom VR/AR solutions that streamline operations, enhance training, and change the way your business works.',
