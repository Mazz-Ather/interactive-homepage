...
const GameHero: React.FC<HeroServiceProps> = ({
  videoSrc = 'https://res.cloudinary.com/dnqcj9kh3/video/upload/v1763379895/DG_1_wvwmnd.mp4',
  miniHeading = 'Service',
  mainHeading = 'Gamfication',
  description = 'Gamification is the strategic application of game-design elements and game principles in non-game contexts. We help businesses leverage the power of play to drive engagement, improve learning outcomes, and motivate behavior. From training simulations to loyalty programs, we make your business goals fun to achieve.',
