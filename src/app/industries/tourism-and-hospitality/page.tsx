...
const servicesOur: Service[] = [
  {
    ...
    detailedDescription:
      "We work with you to define the key narratives and emotional journey you want your guests to have, from the moment they first encounter your brand to their on-site experience.",
  },
  {
    id: 2,
    ...
    detailedDescription:
      "Our team develops stunning 3D assets, animations, and interactive elements, ensuring every detail reflects the unique character of your location.",
  },
  {
    id: 3,
    ...
    detailedDescription:
      "We create a seamless user experience, integrating the immersive content into a platform that is intuitive and easy for your guests to access.",
  },
  {
    id: 4,
    ...
    detailedDescription:
      "We deploy the solution and provide tools for you to track engagement and visitor behavior, allowing you to continually improve the guest experience.",
  },
];
//   animation services
...
const page = () => {
  ...
  const services: ServiceCard[] = [
    {
      title: "Virtual Tours & Showrooms:",
      description:
        " We develop high fidelity virtual tours that allow potential guests and visitors to explore your property or destination from anywhere in the world. This is a powerful tool for marketing and pre-booking, providing an immersive preview of the experience you offer.",
    },
    {
      title: "Interactive Visitor Guides:",
      description: `We use Augmented Reality (AR) to create interactive guides for museums, historical sites, and parks. Visitors can use their smartphones to see digital overlays, 3D models, and animated stories that bring history to life.`,
    },
    {
      title: "Digital Twins for Destinations:",
      description:
        " We build detailed digital twins of large-scale destinations, resorts, and entertainment complexes. These digital replicas can be used for promotional purposes, urban planning, and for providing a streamlined, immersive navigation experience for guests.",
    },
  ];
  ...
  const servicesAnimation: ServiceItem[] = [
    ...
    },
    {
      ...
      title: "The Solution",
      description:
        "We created a comprehensive, photorealistic virtual tour of the entire hotel. Guests can virtually walk through the lobby, explore different room types, and visit amenities like the spa, rooftop pool, and dining areas from any device. Interactive hotspots provide additional information and a direct link to booking.",
    },
    {
      id: 3,
            ...
            <div className="max-w-xl lg:!max-w-[45%] ">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl  lg:text-6xl font-extrabold mb-3 md:mb-4 !leading-none ">
                <span className="bg-gradient-to-r from-[#B54CBE]  to-[#065FE5] bg-clip-text text-transparent !leading-[0.7]">
                  Creating Immersive Guest Experiences with Next-Generation
                  Technology in KSA
                </span>
              </h1>
              ...
              <p className="text-white/85 text-xs sm:text-sm md:text-base leading-relaxed mb-5 md:mb-6">
                The tourism and hospitality sectors in Saudi Arabia are at the
                forefront of a major transformation driven by Vision 2030. We
                help hotels, resorts, cultural sites, and travel destinations
                captivate audiences and create unforgettable experiences. Our
                immersive solutions are designed to attract visitors, enhance
                engagement, and provide a unique, modern journey that
                complements the Kingdom's rich heritage and culture.
              </p>
        ...
        <div className="relative z-10 max-w-8xl mx-auto w-full">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-4">
            <span className="bg-gradient-to-r from-[#B54CBE]  to-[#065FE5] text-transparent bg-clip-text">
              How We Help Tourism & Hospitality
            </span>
          </h2>

          {/* Paragraph */}
          <p className="text-gray-400 text-center text-sm md:text-lg max-w-3xl mx-auto mb-20">
            We create powerful, purpose-built solutions that improve guest
            engagement and elevate brand perception
          </p>
              ...
              <div className="flex flex-col lg:flex-row items-start justify-between mb-16 gap-6">
                ...
                <div className="flex flex-col items-end gap-4 max-w-md ml-auto">
                  <p className="text-gray-900 text-sm sm:text-base md:text-lg leading-relaxed text-right">
                    Our process is built on a foundation of creativity and a
                    deep understanding of what makes an experience truly
                    memorable.
                  </p>
