...
const services: ServiceCard[] = [
  {
    ...
    description:
      'Allow potential buyers to explore a property in a self-guided, photorealistic 3D environment from anywhere in the world.',
  },
  {
    id: 2,
    ...
    description:
      'Integrate features such as a dollhouse view, floor plan toggles, and real-time customization of finishes, furniture, or lighting.',
  },
  {
    id: 3,
    icon: '/images/icon13.png',
    title: 'Unrivaled Accessibility',
    description:
      'Our Digital Twins are accessible across desktop, mobile, and VR headsets, delivering a powerful and flexible experience for every client.',
  },
];


const RealScroll: React.FC = () => {
  ...
  return (
    <div className="w-full py-20 bg-black font-[Cairo]">
      ...
      How We Help with Real Estate Digital Twins

        </h2>
        <p className="text-gray-400 text-center text-lg md:text-xl max-w-3xl mx-auto">
        We create accurate, interactive virtual replicas that provide an unprecedented level of detail and control.
          </p>
      </div>
