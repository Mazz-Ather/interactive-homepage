...
const servicesOur: Service[] = [
  {
    ...
    detailedDescription:
      "We begin with a detailed consultation to identify your specific challenges, whether it's the need for scalable training, improved patient communication, or streamlined facility management.",
  },
  {
    id: 2,
    title: "Medical Content Collaboration",
    href: "/services/3d-modeling",
    image:
      "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=600&h=400&fit=crop",
    description: "Creating detailed 3D models",
    detailedDescription:
      " We work closely with your medical experts and subject matter specialists to ensure the accuracy and clinical relevance of all content and simulations.",
  },
  {
    id: 3,
    ...
    detailedDescription:
      "We prioritize data security and compliance, building solutions that are robust and protect sensitive information, from patient data to proprietary training modules.",
  },
  {
    id: 4,
    ...
    detailedDescription:
      "Each solution undergoes rigorous testing and validation with medical professionals to ensure it is effective and easy to use.",
  },
];
//   animation services
  ...
  const services: ServiceCard[] = [
    {
      ...
      description:
        "We build realistic VR training simulators that allow medical students and professionals to practice complex surgical procedures, emergency response scenarios, and patient care in a risk-free environment. This is an efficient way to hone skills before they are applied in a real-world setting.",
    },
    {
      title: "Patient Education & Therapy:",
      description: `We create engaging AR and VR applications to help patients understand complex medical conditions, visualize treatment plans, and even assist in physical and mental health therapy through immersive experiences.`,
    },
    {
      title: "Hospital and Facility Visualization:",
      description:
        "We develop detailed digital twins of hospitals and clinics, which can be used for staff onboarding, facility navigation, and for planning and managing new construction or renovations.",
    },
  ];
  ...
  const servicesAnimation: ServiceItem[] = [
    {
      ...
      title: "The Challenge",
      description:
        "The Ministry of Energy (MOE) needed a scalable, cost-effective way to train inspectors on safety procedures without requiring on-site visits to remote gas stations.",
    },
    {
      id: 2,
      ...
      title: "The Solution",
      description:
        "We developed an end-to-end VR training platform that included a realistic VR simulation of a gas station and a secure web portal for administrators to manage sessions, track progress, and view analytics.",
    },
    {
      id: 3,
      ...
      title: "The Result",
      description:
        "The solution streamlined the training process, significantly reduced costs, and provided a consistent, high-quality learning experience for inspectors across the Kingdom.",
    },
  ];
  //
  const projects = [
            ...
            <div className="max-w-xl lg:!max-w-[60%] ">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl  lg:text-6xl font-extrabold mb-3 md:mb-4 !leading-none ">
                <span className="bg-gradient-to-r from-[#B54CBE]  to-[#065FE5] bg-clip-text text-transparent !leading-[0.7]">
                  Advancing Healthcare and Medical Training with Immersive
                  Technology in KSA
                </span>
              </h1>
              ...
              <p className="text-white/85 text-xs sm:text-sm md:text-base leading-relaxed mb-5 md:mb-6">
                The healthcare industry is constantly seeking innovative ways to
                improve patient care, enhance professional training, and
                streamline operations. We provide cutting-edge immersive
                solutions that address these needs, helping hospitals, medical
                schools, and pharmaceutical companies in Saudi Arabia deliver
                better outcomes through engaging and highly effective
                technology.
              </p>
      ...
      <section className="relative font-[cairo] bg-black text-white pt-32 pb-36 px-6 overflow-hidden h-auto flex items-center">
        ...
        <div className="relative z-10 max-w-8xl mx-auto w-full">
          ...
          <p className="text-gray-400 text-center text-sm md:text-lg max-w-3xl mx-auto mb-20">
            We blend medical knowledge with immersive technology to create
              ...
              <div className="flex flex-col lg:flex-row items-start justify-between mb-16 gap-6">
                ...
                <div className="flex flex-col items-end gap-4 max-w-md ml-auto">
                  <p className="text-gray-900 text-sm sm:text-base md:text-lg leading-relaxed text-right">
                    Our process is built on a foundation of collaboration and a
                    deep understanding of the healthcare sector's unique
                    requirements.
                  </p>
        ...
        <section className="bg-black text-center pb-11 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-400 text-sm sm:text-base mb-10">
              Let us help you explore the transformative potential of immersive
