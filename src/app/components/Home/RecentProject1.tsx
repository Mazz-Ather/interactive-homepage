...
export const RecentProjects1 = () => {
  ...
  return (
    <div className="w-full bg-black py-16 px-4 md:px-8 lg:px-16 relative overflow-hidden hidden md:block xl100:hidden">
...
<div className="relative z-20 max-w-2xl">
  ...
  <p className="text-gray-300 text-sm md:text-base max-w-[415px] pb-4 lg:pb-11 lg:max-w-[390px]">
    ...
    project to see more details and explore the stories behind our work.
      ...
      {/* Carousel Section */}
      <div className="relative h-[500px] md:h-[550px] lg:h-[750px] max-w-[110vw] mx-auto -mt-[260px]">
