...
const servicesOur: Service[] = [
  {
    ...
    detailedDescription:
      "We collaborate with your team to define specific learning outcomes and identify the key skills to be taught.",
  },
  {
    id: 2,
    title: "Immersive Scenario Design",
    href: "/services/3d-modeling",
    image:
      "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=600&h=400&fit=crop",
    description: "Creating detailed 3D models",
    detailedDescription:
      "Our experts design compelling and realistic scenarios and interactive elements that will provide the most effective learning experience.",
  },
  {
    id: 3,
    ...
    detailedDescription:
      "We build the virtual environment, interactive assets, and all the necessary software to power the simulation.",
  },
  {
    id: 4,
    ...
    detailedDescription:
      " The solution undergoes rigorous testing to ensure it is robust, user-friendly, and ready for a seamless deployment.",
  },
];
//   animation services
  ...
  const services: ServiceCard[] = [
    {
      ...
      description:
        " We build realistic, hands-on VR training simulations for high-stakes industries, allowing users to practice procedures and respond to scenarios in a safe, controlled environment. This reduces costs and risks associated with physical training.",
    },
    {
      title: "Interactive Curricula:",
      description: `We develop interactive lessons and educational content using gamification principles to make complex subjects more engaging and easier to understand, boosting student motivation.`,
    },
    {
      title: "Virtual Classrooms and Labs:",
      description:
        "We create immersive virtual environments for collaborative learning and remote education, breaking down geographical barriers and enabling access to unique learning resources.",
    },
  ];
      ...
      <section className="relative font-[cairo] h-auto -mt-2 w-full overflow-hidden">
        ...
        <div className="relative pt-32 md:pt-[250px] z-10 h-full flex items-center">
          <div className="container mx-auto px-6 md:px-12 lg:px-28">
            <div className="max-w-xl lg:!max-w-[63%] ">
              {/* Mini Heading */}
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl  lg:text-6xl font-extrabold mb-3 md:mb-4 !leading-none ">
                <span className="bg-gradient-to-r from-[#B54CBE]  to-[#065FE5] bg-clip-text text-transparent !leading-[0.7]">
                  Revolutionizing Learning and Development with Immersive
                  Solutions in KSA
                </span>
              </h1>
              ...
              <p className="text-white/85 text-xs sm:text-sm md:text-base leading-relaxed mb-5 md:mb-6">
                In a rapidly changing world, traditional learning methods are no
                longer sufficient. We help educational institutions and
                corporations in Saudi Arabia harness the power of immersive
                technology to create highly effective, engaging, and scalable
                training solutions. Our work transforms learning from a passive
                activity into an active, hands-on experience, leading to better
                knowledge retention and real-world results.
              </p>
        ...
        <div className="relative z-10 max-w-8xl mx-auto w-full">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-4">
            <span className="bg-gradient-to-r from-[#B54CBE]  to-[#065FE5] text-transparent bg-clip-text">
              How We Help Education & Training
            </span>
          </h2>

          {/* Paragraph */}
          <p className="text-gray-400 text-center text-sm md:text-lg max-w-3xl mx-auto mb-20">
            We provide a range of solutions that make learning more effective
            and impactful for both students and professionals.
          </p>
          ...
          <div className="max-w-9xl mx-auto rounded-3xl shadow2xl overflow-hidden relative z-10">
            <div className="px-6 sm:px-8 lg:px-12 py-12 lg:py-16">
              ...
              <div className="flex flex-col lg:flex-row items-start justify-between mb-16 gap-6">
                {/* Title */}
                <div>
                  <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-4xl xl:text-5xl font-light tracking-tight">
                    <span className="bg-gradient-to-r from-[#B54CBE] to-[#065FE5] bg-clip-text text-transparent font-bold">
                      Our Process for Education
                    </span>
                    <br />
                    <span className="bg-gradient-to-r from-[#B54CBE] to-[#065FE5] bg-clip-text text-transparent font-bold">
                      & Training Projects
                ...
                <div className="flex flex-col items-end gap-4 max-w-md ml-auto">
                  <p className="text-gray-900 text-sm sm:text-base md:text-lg leading-relaxed text-right">
                    Our process is rooted in a deep understanding of pedagogical
