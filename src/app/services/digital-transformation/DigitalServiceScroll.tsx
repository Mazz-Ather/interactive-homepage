...
const services: ServiceCard[] = [
  {
    ...
    description:
      'We built a photorealistic VR application that allows inspectors to perform virtual walk-throughs and safety checks of gas stations. This eliminates the need for on-site travel and significantly improves training efficiency.',
  },
  {
    id: 2,
    ...
    description:
      'We developed a secure web portal that allows administrators to schedule sessions, monitor inspector progress, and view detailed reports and analytics from the VR simulations. This provides a complete, integrated solution for managing operations.',
  },
  {
    id: 3,
    icon: '/images/icon13.png',
    title: 'Data-Driven Safety Intelligence',
    description:
      'We transform inspection data into actionable insights using automated scoring and analytics, enabling smarter decision-making, improved compliance, and continuous operational improvement.',
  },
  {
    id: 4,
    ...
    description:
      'We replace manual paperwork with real-time, digitally generated reports that streamline audits, enhance transparency, and accelerate compliance workflows across organizations.',
  },
];
