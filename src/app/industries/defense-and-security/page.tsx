...
const servicesOur: Service[] = [
  {
    id: 1,
    title: "Requirement Analysis & Scenario Design",
    href: "/services/consultation",
    image:
      "https://images.unsplash.com/photo-1551434678-e076c223a692?w=600&h=400&fit=crop",
    description: "Understanding your needs",
    detailedDescription:
      "We work with your subject matter experts to identify specific training needs and design immersive scenarios that are both realistic and aligned with your mission objectives.",
  },
  {
    id: 2,
    title: "Secure Content Creation",
    href: "/services/3d-modeling",
    image:
      "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=600&h=400&fit=crop",
    description: "Creating detailed 3D models",
    detailedDescription:
      "Our team develops the virtual assets and software using a security-first methodology, ensuring the integrity and confidentiality of your sensitive data and training modules.",
  },
  {
    id: 3,
    ...
    detailedDescription:
      "The solutions undergo rigorous testing and validation to guarantee accuracy, realism, and a seamless user experience.",
  },
  {
    id: 4,
    ...
    detailedDescription:
      "We provide on-site deployment and ongoing technical support to ensure your personnel can access and utilize the platform at all times.",
  },
];
//   animation services
...
const page = () => {
  ...
  const services: ServiceCard[] = [
    {
      title: "High Fidelity Training Simulators:",
      description:
        " We design realistic VR training simulators that allow military and security personnel to practice high-risk procedures, from complex equipment operation to tactical drills, without the associated danger or resource cost.",
    },
    {
      title: "Virtual Readiness Platforms:",
      description: `We build secure, custom platforms for managing and deploying training content, ensuring that all personnel have access to the most up-to-date and relevant simulations from a centralized portal.`,
    },
    {
      title: "Situational Awareness & Data Visualization:",
      description:
        "We use immersive technology to turn complex data into intuitive, 3D visualizations, improving decision-making and real-time situational awareness during critical operations.",
    },
  ];
  ...
  const servicesAnimation: ServiceItem[] = [
    {
      ...
      title: "The Challenge",
      description:
        "The Border Guard needed a way to provide realistic and repeatable training on decontamination procedures for soldiers facing nuclear or chemical contamination, without the risks and high costs of a real-world training exercise.",
    },
    {
      id: 2,
      ...
      title: "The Solution",
      description:
        "We developed a VR training platform that immerses soldiers in a detailed, step-by-step decontamination simulation. The application allows users to practice the entire process, from recognizing contamination to performing the correct procedures, with real-time feedback and performance tracking.",
    },
    {
      id: 3,
      ...
      title: "The Result",
      description:
        "The VR simulation enabled the Border Guard to conduct more frequent and accessible training, improving soldier readiness and ensuring protocol adherence in a safe, controlled virtual environment.",
    },
  ];
  //
  const projects = [
            ...
            <div className="max-w-xl lg:!max-w-[45%] ">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl  lg:text-6xl font-extrabold mb-3 md:mb-4 !leading-none ">
                <span className="bg-gradient-to-r from-[#B54CBE]  to-[#065FE5] bg-clip-text text-transparent !leading-[0.7]">
                  Delivering Mission-Critical Training & Operations with
                  Immersive Technology in KSA
                </span>
              </h1>

              {/* Paragraph - Smaller Size */}
              <p className="text-white/85 text-xs sm:text-sm md:text-base leading-relaxed mb-5 md:mb-6">
                In the defense and security sectors, effective training and
                operational readiness are paramount. We provide advanced
                immersive solutions that enable military and security
                organizations in Saudi Arabia to prepare for complex scenarios
                in a safe, cost-effective, and highly realistic virtual
                environment. Our technology enhances situational awareness,
                refines tactical skills, and ensures personnel are ready for any
                challenge.
              </p>
      ...
      <section className="relative font-[cairo] bg-black text-white pt-32 pb-36 px-6 overflow-hidden h-auto flex items-center">
        ...
        <div className="relative z-10 max-w-8xl mx-auto w-full">
          ...
          <p className="text-gray-400 text-center text-sm md:text-lg max-w-3xl mx-auto mb-20">
            ...
            improve readiness and mission effectiveness.
          </p>
              ...
              <div className="flex flex-col lg:flex-row items-start justify-between mb-16 gap-6">
                ...
                <div className="flex flex-col items-end gap-4 max-w-md ml-auto">
                  <p className="text-gray-900 text-sm sm:text-base md:text-lg leading-relaxed text-right">
                    Our approach is built on a foundation of security,
                    precision, and collaboration with our clients to ensure
                    every solution is mission-ready.
                  </p>
        ...
        <div className="relative z-10 w-full px-4 py-8">
          ...
          >
            ...
            <p className="mx-auto max-w-2xl text-base text-gray-300 md:text-lg lg:text-xl">
              VR Decontamination Training for Border Guard
            </p>
          </motion.div>
