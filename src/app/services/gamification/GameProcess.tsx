...
const steps: ProcessStep[] = [
  {
    ...
    description:
      ' We start by identifying your primary goal, whether it is increasing sales, improving knowledge retention, or boosting a specific user behavior',
  },
  {
    id: 2,
    number: '02',
    ...
    description:
      'We analyze your target audience to understand their motivations and design a user journey that will keep them engaged.',
  },
  {
    id: 3,
    number: '03',
    ...
    description:
      'We select and design the perfect game mechanics, from leaderboards and achievements to reward systems and narratives',
  },
  {
    id: 4,
    number: '04',
    ...
    description:
      'Our developers build the gamified solution and seamlessly integrate it into your platform.',
  },
];
