...
const ProductionProcess: React.FC = () => {
  ...
  const steps: ProcessStep[] = [
    ...
    },
    {
      ...
      description: 'We add realistic lighting and render high-quality visuals for your project.',
    },
    {
      id: 5,
      number: '05',
      title: 'POST-PRODUCTION:',
      description: 'Final touches including color grading, effects, and sound design to polish your video.',
    },
  ];
  ...
  return (
    <section className="relative font-[Cairo]  w-full bg-black px-6 md:px-12 lg:px-20 overflow-hidden">
      {/* Background Video */}
      <video
        autoPlay
        loop
      ...
      <div className="absolute top-1/4 left-0 w-96 h-96 bg-purple-600/30 rounded-full blur-3xl z-[2] transition-all duration-1000"></div>
      <div className="absolute top-1/2 right-0 w-96 h-96 bg-orange-600/20 rounded-full blur-3xl z-[2] transition-all duration-1000"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="relative py8 max-w-[560px] mx-auto w-full">
