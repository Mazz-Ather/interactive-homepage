...
const VRHeroPage = () => {
  return (
    <div className="lg:min-h-screen container max-w-[1800px] mx-auto -mt-9">
      ...
      <div className="relative max-w-[1800px] mx-auto lg:h-screen overflow-hidden">
        ...
        <div className="relative z-10 h-screen bg-black/70 pt-6">
          ...
          <div className="lg:hidden flex flex-col min-h-screen px-6 py-8 space-y-12">
            ...
            <div className="relative w-full flex justify-center items-center">
              <img
                src="/images/vr.png"
                alt="VR Headset"
                className="w-full sm:max-w-[600px] h-auto -rotate-[10.35deg] object-contain filter drop-shadow-2xl"
              />
            </div>
          ...
          <div className="hidden lg:block relative min-h-screen">
            <div className="absolute top-1 lg:top-[50px] left-16 xl:left-24 2xl:left-32 z-20">
            ...
            <div className="absolute top-[66%] lg:top-[55%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
              <div className="relative">
                ...
                <div className="absolute top-[55%] lg:top-[48%] -right-[350px] lg:-right-[270px] xl:-right-[300px] 2xl:-right-[290px] max-w-[300px]">
                  <img
                    src="/images/arrow.png"
                    alt="Arrow pointing to VR"
                    className="w-[250px] lg:w-[200px] xl:w-[260px] absolute top-[-50px] -left-[150px] lg:-left-[90px] xl:-left-[130px] 2xl:-left-[130px] flex-shrink-0 transform opacity-100"
                  />
          ...
          <div className="absolute bottom-8 xl:bottom-12 right-16 xl:right-24 2xl:right-32 hidden lg:block z-20">
